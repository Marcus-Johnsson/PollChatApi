...
namespace PollChatApi.Migrations
{
    ...
    [Migration("20250613005157_warning44")]
    partial class warning44
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PollChatApi.Model.Warning", b =>
                {
                    ...
                    b.Property<DateTime?>("HandeldAtTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SubjectUser", b =>
                {
                    b.Property<int>("FavoriteSubjectsId")
                        .HasColumnType("int");

                    b.Property<string>("SubscribedUsersId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("FavoriteSubjectsId", "SubscribedUsersId");
            ...
            modelBuilder.Entity("PollChatApi.Model.Comment", b =>
                {
                    ...
                    b.HasOne("PollChatApi.Model.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("SubjectUser", b =>
                {
                    b.HasOne("PollChatApi.Model.Subject", null)
                        .WithMany()
                        .HasForeignKey("FavoriteSubjectsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
